...
char mensaje1[] = "HOLA MUNDO "; //Escriba el mensaje a desplegar 
...
void loop(){
  ...
  boolean i1 = digitalRead(A5);
  boolean i2 = digitalRead(A4);
    boolean i3 = digitalRead(A3);
  boolean i4 = digitalRead(A2);
 ...
 if(i1 == 1){
  ...
  printStringWithShift(mensaje1, 60);
 ...
 if(i2 == 1){
  ...
  printStringWithShift(mensaje2, 60);
  }
}
